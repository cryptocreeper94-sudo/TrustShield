    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <Badge className="mb-4 bg-gradient-to-r from-sky-500/20 to-cyan-500/20 text-sky-400 border-sky-500/30">
            <Building2 className="w-3 h-3 mr-1" />
            Business Verification
          </Badge>
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-sky-400 via-cyan-400 to-red-400 bg-clip-text text-transparent mb-4">
          ...
          <div className="flex items-center gap-2">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center">
                ...
                {s < 3 && (
                  <div className={`w-12 h-1 mx-2 rounded ${step > s ? "bg-sky-500" : "bg-white/10"}`} />
                )}
              </div>
            ))}
          </div>
            ...
            >
              ...
              <div className="p-4 bg-sky-500/10 border border-sky-500/30 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sky-300 font-medium text-sm">Why We Verify</p>
            ...
            >
              ...
              <div className="p-4 bg-sky-500/10 border border-sky-500/30 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sky-300 font-medium text-sm">What Happens Next</p>
                    <p className="text-white/60 text-xs mt-1">
              ...
              <div className="flex justify-between">
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-sky-600 to-cyan-600 hover:from-sky-500 hover:to-cyan-500 min-w-[160px]"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {businessBenefits.map((benefit, i) => (
              <GlassCard key={i} className="p-4 text-center">
                <benefit.icon className="w-6 h-6 text-sky-400 mx-auto mb-2" />
