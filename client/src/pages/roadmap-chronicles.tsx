      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/10 border border-sky-500/30">
              <Users className="w-4 h-4 text-sky-400" />
              <span className="text-sky-300 text-sm">Community-driven timeline — your involvement shapes when we launch</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-4xl font-bold bg-gradient-to-r from-sky-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">
              ...
              <div className="h-4 bg-black/50 backdrop-blur-sm rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-sky-500 via-pink-500 to-cyan-500"
                />
              </div>
            </div>
          </div>
