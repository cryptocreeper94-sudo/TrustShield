        ...
        <GlassCard className="p-4" glow>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`text-2xl font-bold ${
              ...
              token.securityScore >= 40 ? 'text-sky-400' : 'text-red-400'
            }`}>
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className={`font-medium ${token.top10HoldersPercent > 50 ? 'text-red-400' : token.top10HoldersPercent > 30 ? 'text-sky-400' : 'text-emerald-400'}`}>
                  {token.top10HoldersPercent.toFixed(1)}%
                </span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <div 
                  className={`h-full ${token.top10HoldersPercent > 50 ? 'bg-red-500' : token.top10HoldersPercent > 30 ? 'bg-sky-500' : 'bg-emerald-500'}`}
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className={`font-medium ${token.botPercent > 10 ? 'text-red-400' : token.botPercent > 5 ? 'text-sky-400' : 'text-emerald-400'}`}>
                  {token.botPercent.toFixed(1)}%
                </span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <div 
                  className={`h-full ${token.botPercent > 10 ? 'bg-red-500' : token.botPercent > 5 ? 'bg-sky-500' : 'bg-emerald-500'}`}
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className={`font-medium ${token.bundlePercent > 15 ? 'text-red-400' : token.bundlePercent > 5 ? 'text-sky-400' : 'text-emerald-400'}`}>
                  {token.bundlePercent.toFixed(1)}%
                </span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <div 
                  className={`h-full ${token.bundlePercent > 15 ? 'bg-red-500' : token.bundlePercent > 5 ? 'bg-sky-500' : 'bg-emerald-500'}`}
