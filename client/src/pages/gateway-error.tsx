...
export default function GatewayError() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-sky-900/20 to-slate-950 flex items-center justify-center p-4">
      {/* Ambient glow orbs */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          {/* Title */}
          <h1 className="text-3xl font-bold text-center mb-3 bg-gradient-to-r from-cyan-400 to-sky-400 bg-clip-text text-transparent">
