            ...
            <div className="relative">
              ...
              <div ref={carouselRef} className="flex gap-4 overflow-x-auto scrollbar-hide px-8 py-4 snap-x snap-mandatory touch-pan-x">
                {[
                  ...
                  { title: "ChronoChat", desc: "Community platform with real-time messaging, channels, reactions, and Shells virtual currency.", img: chronochatImg, href: "/signal-chat", domain: "dwsc.io" },
