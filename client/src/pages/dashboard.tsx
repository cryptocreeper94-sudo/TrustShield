        ...
        <div className="container mx-auto max-w-6xl">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {!trustCard && !trustCardLoading && (
                  <Link href="/trust-layer">
                    <Button size="sm" variant="outline" className="gap-1 border-sky-500/30 text-sky-400 hover:bg-sky-500/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <Link href="/business-portal">
              <GlassCard glow className="p-5 cursor-pointer hover:border-sky-500/30 transition-all group h-full">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-sky-500/30 to-pink-500/30 flex items-center justify-center">
                  ...
                  <ArrowRight className="w-4 h-4 text-white/40 group-hover:text-sky-400 transition-colors" />
                </div>
            ...
            <Link href="/membership-charter">
              <GlassCard glow className="p-5 cursor-pointer hover:border-sky-500/30 transition-all group h-full">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-sky-500/30 to-cyan-500/30 flex items-center justify-center">
