...
export default function FoundersPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-40 right-10 w-80 h-80 bg-sky-500/10 rounded-full blur-3xl" />
        ...
        >
          <div className="text-center mb-12">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-sky-500/20 to-cyan-500/20 border border-sky-500/30 mb-6"
            >
              <Crown className="w-5 h-5 text-sky-400" />
              <span className="text-sky-300 font-medium">Exclusive Telegram Offer</span>
            </motion.div>

            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6">
              <span className="bg-gradient-to-r from-sky-400 via-cyan-400 to-red-400 bg-clip-text text-transparent">
                Founders Circle
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-white/80 mb-4 max-w-2xl mx-auto">
              The first <span className="text-sky-400 font-bold">100 buyers</span> get up to{" "}
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-white/10 p-6 sm:p-8 md:p-12 shadow-2xl mb-8">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gradient-to-br from-sky-500/10 to-cyan-500/10 rounded-2xl p-6 md:p-8 border border-sky-500/20">
            ...
            <div className="text-center">
              <Link href="/presale?ref=founders">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 text-white font-bold text-lg px-12 py-6 h-auto"
