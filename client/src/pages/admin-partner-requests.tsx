...
export default function AdminPartnerRequests() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "pending":
        return <Badge className="bg-sky-500/20 text-sky-400 border-sky-500/30"><Clock className="w-3 h-3 mr-1" />Pending</Badge>;
      case "approved":
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white p-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <Card className="bg-sky-950/20 border-sky-500/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-sky-400 text-2xl">{pendingRequests.length}</CardTitle>
