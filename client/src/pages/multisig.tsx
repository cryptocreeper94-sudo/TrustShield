...
export default function MultiSigPage() {
  ...
  const getOpIcon = (type: string) => {
    switch (type) {
      ...
      case "update_threshold": return <Key className="h-4 w-4 text-sky-400" />;
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <div className="p-3 rounded-xl bg-gradient-to-br from-sky-500/20 to-cyan-600/20 border border-sky-500/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          >
            ...
            <div className="text-2xl font-bold text-sky-400">{pendingOps.filter(o => o.status === "pending").length}</div>
          </motion.div>
        ...
        >
          <CollapsibleTrigger className="w-full">
            <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-sky-500/10 to-cyan-600/10 border border-sky-500/30 hover:border-sky-400/50 transition-colors cursor-pointer">
              <div className="flex items-center gap-3">
                <Vote className="h-5 w-5 text-sky-400" />
                <span className="text-lg font-semibold text-white">Pending Operations</span>
                <span className="px-2 py-0.5 rounded-full bg-sky-500/20 text-sky-400 text-sm">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-1 text-sm text-slate-400">
                          ...
                          <span className="text-sky-400">Expires in {op.expiresAt}</span>
                        </div>
                        {op.amount && (
                    ...
                    <div className="flex items-center gap-2">
                      <div className="text-right mr-4">
                        ...
                        <div className={`text-lg font-bold ${op.currentSignatures >= op.requiredSignatures ? 'text-green-400' : 'text-sky-400'}`}>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`w-3 h-3 rounded-full ${
                        ...
                        validator.status === 'pending' ? 'bg-sky-400' : 'bg-slate-500'
                      }`} />
                      <div>
                    ...
                    <div className="flex items-center gap-6 text-sm">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        ...
                        validator.status === 'pending' ? 'bg-sky-500/20 text-sky-400' :
