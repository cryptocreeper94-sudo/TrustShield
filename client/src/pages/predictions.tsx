        ...
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <h1 className="text-2xl md:text-3xl font-display font-bold mb-2">
              Prediction <span className="text-sky-400">Markets</span>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            <GlassCard hover={false} className="p-3 text-center">
              <BarChart3 className="w-5 h-5 mx-auto mb-1 text-sky-400" />
          ...
          {!isConnected && (
            <GlassCard glow className="p-4 mb-6">
              <div className="flex items-center justify-between">
                ...
                <Link href="/wallet">
                  <Button className="bg-gradient-to-r from-sky-500 to-cyan-500" data-testid="button-connect-predictions">
          ...
          <GlassCard className="mt-6 p-4 text-center">
            ...
            {isConnected ? (
              <Button className="bg-gradient-to-r from-sky-500 to-cyan-500" data-testid="button-create-market">
