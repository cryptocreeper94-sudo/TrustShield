    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-sky-400 to-pink-400 bg-clip-text text-transparent mb-4">
            Membership Charter
          </h1>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <GlassCard glow className="p-6 md:p-8 bg-gradient-to-br from-cyan-500/5 via-sky-500/5 to-pink-500/5">
              ...
              <motion.div key={i} variants={staggerItem}>
                <GlassCard glow className="p-6 text-center h-full hover:border-cyan-500/30 transition-all duration-300">
                  <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${
                    ...
                    value.color === "purple" ? "from-sky-500/30 to-pink-500/30" :
                    ...
                    <value.icon className={`w-7 h-7 ${
                      ...
                      value.color === "purple" ? "text-sky-400" :
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <GlassCard glow className="p-6 md:p-8 bg-gradient-to-br from-sky-500/5 to-pink-500/5">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-sky-500/30 to-pink-500/30 flex items-center justify-center shadow-lg shadow-sky-500/20">
                ...
                <Carousel opts={{ align: "start", loop: true }} className="w-full">
                  <CarouselContent className="-ml-2 md:-ml-4">
                    {businessBenefits.map((benefit, i) => (
                      <CarouselItem key={i} className="pl-2 md:pl-4 basis-full sm:basis-1/2">
                        <div className="p-4 bg-white/5 rounded-xl border border-white/10 h-full hover:border-sky-500/30 transition-colors">
                          <benefit.icon className="w-6 h-6 text-sky-400 mb-3" />
                          <h4 className="font-semibold text-white mb-1">{benefit.title}</h4>
                          <p className="text-sm text-white/60">{benefit.text}</p>
                        </div>
                      </CarouselItem>
                  ...
                  <div className="flex justify-center gap-2 mt-4">
                    <CarouselPrevious className="static translate-y-0 bg-white/10 border-white/20 hover:bg-sky-500/20" />
                    <CarouselNext className="static translate-y-0 bg-white/10 border-white/20 hover:bg-sky-500/20" />
                  </div>
                </Carousel>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/10">
                <Link href="/business-portal">
                  <Button className="w-full bg-gradient-to-r from-sky-600 to-pink-600 hover:from-sky-500 hover:to-pink-500 shadow-lg shadow-sky-500/20" data-testid="link-business-portal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {tiers.map((tier, i) => (
              ...
              >
                <GlassCard 
                  glow 
                  className={`p-6 h-full relative ${tier.popular ? "ring-2 ring-sky-500/50 shadow-lg shadow-sky-500/20" : ""} bg-gradient-to-br ${tier.gradient}`}
                >
                  {tier.popular && (
                    <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-sky-500 to-pink-500 text-white border-0 shadow-lg">
                      <Sparkles className="w-3 h-3 mr-1" />
                      Most Popular
                    </Badge>
                  )}
                  <h3 className={`text-2xl font-bold mb-1 ${
                    ...
                    tier.color === "purple" ? "text-sky-400" :
                    "text-sky-400"
                  }`}>{tier.name}</h3>
                  ...
                  <Button 
                    className={`w-full mt-6 ${
                      tier.popular 
                        ? "bg-gradient-to-r from-sky-600 to-pink-600 hover:from-sky-500 hover:to-pink-500 shadow-lg"
        ...
        >
          <GlassCard glow className="p-8 md:p-12 bg-gradient-to-r from-cyan-500/10 via-sky-500/10 to-pink-500/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {user ? (
                <>
                  ...
                  <Link href="/business-portal">
                    <Button size="lg" variant="outline" className="border-sky-500/50 text-sky-400 hover:bg-sky-500/10 min-w-[200px]" data-testid="button-join-business">
                ...
                <Link href="/login">
                  <Button size="lg" className="bg-gradient-to-r from-cyan-600 via-sky-600 to-pink-600 hover:from-cyan-500 hover:via-sky-500 hover:to-pink-500 min-w-[200px] shadow-lg shadow-sky-500/20" data-testid="button-get-started">
