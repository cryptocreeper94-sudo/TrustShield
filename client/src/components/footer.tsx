          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                <li><Link href="/scanner" className="hover:text-cyan-400 transition-colors">Scanner</Link></li>
                <li><Link href="/registry" className="hover:text-cyan-400 transition-colors">Registry</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                ...
                <li><a href="https://trustgen.tlid.io" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">TrustGen 3D</a></li>
              </ul>
            </div>
            <div>
